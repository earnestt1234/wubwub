...
def trackplot(track, yaxis='semitones', timesig=4, grid=True, ax=None,
    ...
    ![](https://raw.githubusercontent.com/earnestt1234/wubwub/main/img/electro_hinote1_trackplot_semitones.png)

    ```python
    seq['hinote1'].plot(yaxis='pitch')
    ```

    ![](https://raw.githubusercontent.com/earnestt1234/wubwub/main/img/electro_hinote1_trackplot_pitch.png)
...
def pianoroll(track, timesig=4, grid=True,):
    ...
    ![](https://raw.githubusercontent.com/earnestt1234/wubwub/main/img/lofi_rhodes2_pianoroll.png)
